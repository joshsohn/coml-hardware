                                         ...
                                         const Goal& goal)
{
  ...
  // const Eigen::Vector3d w_ref = Eigen::Vector3d(0.0, 0.0, 0.0);
...
Eigen::Vector3d OuterLoop::getForce(double dt, const State& state, const Goal& goal)
{
  ...
  Eigen::Vector3d e = Eigen::Vector3d(0.0, 0.0, 1.0) - state.p;
  ...
  const Eigen::Vector3d F_W = params_.mass * (a_fb - GRAVITY);
